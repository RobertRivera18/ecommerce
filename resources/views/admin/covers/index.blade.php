...
[
    ...
    <x-slot name="action">
        <a class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
            href="{{route('admin.covers.create')}}">Nuevo</a>
    </x-slot>
    ...
    <ul class="space-y-4" id="covers">
        ...
        <li class="bg-white rounded-lg shadow-lg  overflow-hidden lg:flex cursor-move" data-id="{{$cover->id}}">
            <img src="{{$cover->image}}" alt="" class="lg:w-64 aspect-[3/1] object-cover object-center w-full">
            <div class="p-4 lg:flex-1 lg:flex lg:justify-between lg:items-center space-y-2 lg:space-x-0">
                ...
                <div>
                    <a class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-4 py-2 me-2 mb-2"
                        href="{{route('admin.covers.edit',$cover)}}">Editar</a>
                </div>
            </div>
        </li>
        @endforeach
