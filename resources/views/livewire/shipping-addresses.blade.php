    ...
    <section class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-4">
            ...
            <div class="grid grid-cols-4 gap-2">
                ...
                <div class="col-span-2">
                    <x-input wire:model="editAddress.ciudad" class="w-full" type="text" placeholder="Ciudad" />
                </div>

                <div class="col-span-2">
                    <x-input wire:model="editAddress.reference" class="w-full" type="text" placeholder="Referencia" />
                </div>
            </div>
            <hr class="my-4">
                ...
                <li class="{{$address->default ?'bg-purple-200':'bg-white'}} rounded-lg shadow"
                    ...
                    <div class="p-4 flex items-center">
                        ...
                        <div class="text-xs text-gray-800 flex flex-col">
                            ...
                            <button wire:click="edit({{$address->id}})"><i class="fas fa-pencil"></i></button>
